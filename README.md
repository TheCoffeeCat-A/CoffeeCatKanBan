...
- 新卡片默认归入主看板同目录下的 "看板文件名-卡片" 子文件夹, 新建窗口显示实际保存位置
...
默认结构为 `项目/项目看板.md` 与 `项目/项目看板-卡片/卡片标题.md`, 首张卡片创建时自动建立子文件夹, 同名卡片按序号避让

新建看板的 "新任务文件夹" 相对于看板所在目录, 留空按看板文件名分类, 也可指定子文件夹名称或多级路径

已有看板的任务目录若与主看板同级或位于其他目录, 后续新建改用主看板旁的专用子文件夹; 已配置在主看板目录下的子文件夹继续使用。已有卡片保持原路径和归属, 复制仍保留源文件夹以保持正文相对链接含义
